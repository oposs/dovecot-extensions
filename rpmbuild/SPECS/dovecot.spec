...
# hin fingerprint patch
Patch0: dovecot-2.2.19-fingerprint.patch
...
#rp %dir %{_libdir}/dovecot/settings

%{_libexecdir}/%{name}
#rp %exclude %{_libexecdir}/%{name}/managesieve*
...
%changelog
* Thu Nov 19 2015 Manuel Oetiker <manuel@oetiker.ch> - 1:2.2.19-2-MES
- update patch form 2.2.12 to add fingerprint
...
* Thu Apr 03 2014 Roman Plessl <roman.plessl@oetiker.ch> - 1:2.2.12-3-MES
- Port for Mail Entry Server
